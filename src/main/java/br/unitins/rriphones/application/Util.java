...
public class Util {
	...
	public static boolean saveImageIphone(InputStream inputStream, String imageType, int idIphone) {
		String diretorio = System.getProperty("user.home") + ImgIphoneServlet.PATH_IMAGES_IPHONE;
		...
		try {
			...
			// estrutura final do arquivo ex: /home/janio/images/usuario/01.png
			File arquivoFinal = new File(diretorio + File.separator + idIphone + "." + imageType);
			// salvando a imagem
			// buffer da imagem, png/gif, 01.png
			ImageIO.write(bImage, imageType, arquivoFinal);
