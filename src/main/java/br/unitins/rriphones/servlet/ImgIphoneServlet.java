package br.unitins.rriphones.servlet;
...
@WebServlet("/img-iphone")
public class ImgIphoneServlet extends HttpServlet {
	...
	// /images/iphone
	public static final String PATH_IMAGES_IPHONE = PATH_IMAGES + File.separator + "iphone";
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // C:\\Users\\janio\\images\\iphone\\
        String diretorio = System.getProperty("user.home") + File.separator + PATH_IMAGES_IPHONE + File.separator;
        
        // montando a imagem com e endereco do servidor
        // /home/janio/images/iphone/2.png
